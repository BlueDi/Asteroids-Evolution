...
/**
 * TODO: talvez por as naves a terem que aprender que asteroides sao maus, e
 * comida é bom
 */
public class Ship extends SpaceObject {
	...
	/**
	 * Searches the closest Food and flies in its direction. TODO: converter de
	 * array de Food para array de SpaceObjects
	 *
	 * @param food
	 *            Food to search
	 */
	...
	/**
	 * Searches the closest Asteroid and, if the difference between it and the
	 * closest Food is less than Setting.SIP_DISNTACE_STOP_DODGE, the ship is
	 * rotated to fly in the opposite direction. TODO: converter de array de
	 * Asteroids para array de SpaceObjects
	 *
	 * @param asteroids
	 *            Asteroids to search
	 */
	...
	/**
	 * Rotates the Ship into the desired orientation. The Ship rotation isn't
	 * instantaneous, so it must receive the time elapsed.
	 *
	 * @param dt
	 *            Time elapsed
	 */
	...
	/**
	 * Acceleration. If the Ship velocity is less than its max speed, increase
	 * speed.
	 *
	 * @param dt
	 *            Time elapsed
	...
	/**
	 * Friction. Maybe a Space Ship shouldn't have friction...
	 *
	 * @param dt
	 *            Time elapsed
	 */
	 ...
	 * <p>
	 * [maxSpeed; acceleration; deceleration; distanceToDodge; rotationSpeed;
	 * satisfiableAngle; lifeTime]
	 *
	 * @return String with Ship stats
	 */
	public String toString() {
		return "[" + String.format("%4.0f", maxSpeed) + "; " + String.format("%4.0f", acceleration) + "; "
				+ String.format("%4.0f", deceleration) + "; " + String.format("%3.0f", distanceToDodge) + "; "
				+ String.format("%.2f", rotationSpeed) + "; " + String.format("%.2f", satisfiableAngle) + "; "
				+ String.format("%3.0f", lifeTime) + "]";
	}
	 ...
	 *
	 * @param sr
	 *            ShapeRenderer where the Ship will be drawn.
	 */
